infra/run:
	...
	ansible-playbook --inventory-file hosts.yml main.yml --vault-password-file ansible_vault_pwd.txt --become-password-file become-password -u=rkeoci --private-key /home/rodrigo/projects/rancher-rke/keys/devsecops.pem
	sleep 180
